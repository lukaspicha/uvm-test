<?php
// source: C:\xampp\htdocs\picha\app/config/config.neon 
// source: C:\xampp\htdocs\picha\app/config/config.local.neon 

class Container_404a8d97b2 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\ContactFormFactory' => [1 => ['24_App_Forms_ContactFormFactory']],
			'App\Forms\FormFactory' => [1 => ['25_App_Forms_FormFactory']],
			'App\Forms\ParserFormFactory' => [1 => ['26_App_Forms_ParserFormFactory']],
			'App\Forms\SignInFormFactory' => [1 => ['27_App_Forms_SignInFormFactory']],
			'App\Forms\SignUpFormFactory' => [1 => ['28_App_Forms_SignUpFormFactory']],
			'App\Model\BaseModel' => [1 => ['29_App_Model_DemandModel', '30_App_Model_ParserModel']],
			'App\Model\DemandModel' => [1 => ['29_App_Model_DemandModel']],
			'App\Model\ParserModel' => [1 => ['30_App_Model_ParserModel']],
		...
		'services' => [
			'24_App_Forms_ContactFormFactory' => 'App\Forms\ContactFormFactory',
			'25_App_Forms_FormFactory' => 'App\Forms\FormFactory',
			'26_App_Forms_ParserFormFactory' => 'App\Forms\ParserFormFactory',
			'27_App_Forms_SignInFormFactory' => 'App\Forms\SignInFormFactory',
			'28_App_Forms_SignUpFormFactory' => 'App\Forms\SignUpFormFactory',
			'29_App_Model_DemandModel' => 'App\Model\DemandModel',
			'30_App_Model_ParserModel' => 'App\Model\ParserModel',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\picha\app',
			'wwwDir' => 'C:\xampp\htdocs\picha\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\picha\app/../temp',
		];
	}


	/**
	 * @return App\Forms\ContactFormFactory
	 */
	public function createService__24_App_Forms_ContactFormFactory()
	{
		$service = new App\Forms\ContactFormFactory($this->getService('25_App_Forms_FormFactory'),
			$this->getService('29_App_Model_DemandModel'));
		return $service;
	}
	...
	/**
	 * @return App\Forms\ParserFormFactory
	 */
	public function createService__26_App_Forms_ParserFormFactory()
	{
		$service = new App\Forms\ParserFormFactory($this->getService('25_App_Forms_FormFactory'),
			$this->getService('30_App_Model_ParserModel'));
		return $service;
	}
	...
	/**
	 * @return App\Model\DemandModel
	 */
	public function createService__29_App_Model_DemandModel()
	{
		$service = new App\Model\DemandModel($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\ParserModel
	 */
	public function createService__30_App_Model_ParserModel()
	{
		$service = new App\Model\ParserModel($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createServiceApplication__3()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->parserFormFactory = $this->getService('26_App_Forms_ParserFormFactory');
		$service->contactFormFactory = $this->getService('24_App_Forms_ContactFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	public function createServiceApplication__4()
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->signUpFactory = $this->getService('28_App_Forms_SignUpFormFactory');
		$service->signInFactory = $this->getService('27_App_Forms_SignInFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\picha\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\picha\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\picha\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=picha', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_404a8d97b2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_404a8d97b2_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_404a8d97b2 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\picha\app/../temp/cache/latte');
